...
options:
  ...
  --context CONTEXT     Python statement defining a context for given Python expressions.
                        Extends eventual definitions given via --context-file. Any global variables (or
  ...
  --context-file CONTEXT_FILE
                        ...
                        Any global variables (or functions) become available in the Python expressions
