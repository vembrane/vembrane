...
annotation:
    ...
    - value: # a new annotation entry in the info field of the vcf
        ...
        expression: "DATA['score'][0]" # any python expression to calulcate the value(s)
